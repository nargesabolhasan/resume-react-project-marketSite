        ...
        >
          ...
          <PhotoWraper>
            ...
            <Paragraph sx={{ fontSize: { xs: 15, md: 20, lg: 20 } }}>
              ...
              کاربری‌های مختلف آماده کار باشند. تراشه M1 هسته اصلی قدرت و پردازش
              آیپد پرو ۲۰۲۱ نسل ۵ آیپد جدید از پردازنده‌ای استفاده می‌کند که تا
              پیش از این فقط و فقط در کامپیوترهای مک مبتنی بر اپل سیلیکون تعبیه
              شده بود. این موضوع باعث شده تا آیپد بتواند در سیستم عامل آیپد او
              اس قدرتی مشابه با مک بوک‌ها را به کاربر خود ارائه دهد و بدون
              محدودیت کارهای مختلف و وظایف مورد نیاز کاربر را اجرا کند. تراشه M1
              باعث شده تا آیپد پروی جدید به سریع‌ترین دستگاه در نوع خود تبدیل
              شود. این تراشه طراحی شده تا بیشترین امکانات را به علاقه‌مندان
              فناوری و تکنولوژی ارائه دهد و از آن طریق کاربران بتوانند بدون نیاز
              به کامپیوترهای دیگر تمامی کارهای مورد نظر خود را انجام دهند.
              <br></br>
              جالب اینجا است که قدرت پردازشی آیپد جدید افزایش قابل توجهی داشته
              است و در عین حال مصرف باتری و انرژی این محصول نیز به طور کلی بهبود
              داشته است. آیپد پرو می‌تواند با یک بار شارژ باتری برای یک روز کاری
              کامل پاسخگوی نیازهای کاربر باشد و تمامی امکانات ممکن را در اختیار
              استفاده کننده خود قرار دهد. تراشه M1 تعبیه شده در این آیپدها دارای
              ۸ هسته پردازش مرکزی، ۸ هسته پردازش گرافیکی و ۱۶ هسته مربوط به
              پردازش‌های هوشمند مصنوعی است که در مجموع باعث شده تا قدرت پردازنده
              تا ۵۰ درصد نسبت به نسل پیشین بهبود داشته باشد و قدرت پردازش
              گرافیکی نیز تا ۴۰ درصد در دستگاه‌های جدید سریع‌تر شود. نمایشگر
              باکیفیت‌تر که تا پیش از این هرگز معادل آن را ندیده‌اید
            </Paragraph>
          </PhotoWraper>
        </Box>
      </Div>
